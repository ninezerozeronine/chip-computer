...
async def main():
    ...
    if args.test:
        ...
        for counter, chunk in enumerate(data_chunks, start=1):
            ...
            await send_job(args.ip_address, int(args.port), str_job)
            await asyncio.sleep(2)
    else:        
        await send_job(args.ip_address, int(args.port), args.job)
...
"{\"function\":\"propose_user_input_character\", \"args\":[\"1\"]}"