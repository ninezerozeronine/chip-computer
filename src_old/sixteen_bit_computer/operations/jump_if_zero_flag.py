...
def generate_microcode_templates():
    ...
    Returns:
        ...
        JUMP_IF_ZERO_FLAG instructions.
    """
...
def parse_line(line):
    ...
    If a line is not identifiably a JUMP_IF_ZERO_FLAG assembly line,
    ...
    return jump_if_flag_base.parse_line(line, "ACC", _NAME)
