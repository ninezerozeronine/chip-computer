...
from sixteen_bit_computer.operations import jump_if_eq_acc_op
...
def generate_parse_line_test_data():
    ...
    test_input = "   JUMP_IF_EQ_ACC B #123   "
    mc_0 = get_machine_code_byte_template()
    mc_0["byte_type"] = "instruction"
    mc_0["bitstring"] = "00010111"
    ...
    test_input = "   JUMP_IF_EQ_ACC #55 #123   "
    mc_0 = get_machine_code_byte_template()
    mc_0["byte_type"] = "instruction"
    mc_0["bitstring"] = "00000111"
...
def test_parse_line(test_input, expected):
    assert jump_if_eq_acc_op.parse_line(test_input) == expected
