...
from sixteen_bit_computer.operations import jump_if_lte_acc_op
...
def generate_parse_line_test_data():
    ...
    test_input = "   JUMP_IF_LTE_ACC B #123   "
    mc_0 = get_machine_code_byte_template()
    mc_0["byte_type"] = "instruction"
    mc_0["bitstring"] = "00010110"
    ...
    test_input = "   JUMP_IF_LTE_ACC #55 #123   "
    mc_0 = get_machine_code_byte_template()
    mc_0["byte_type"] = "instruction"
    mc_0["bitstring"] = "00111110"
...
def test_parse_line(test_input, expected):
    assert jump_if_lte_acc_op.parse_line(test_input) == expected
...
@pytest.mark.parametrize("test_input", [
    ...
    "JUMP_IF_LTE_ACC A",
    "JUMP_IF_LTE_ACC A B",
    "JUMP_IF_LTE_ACC #123 A",
    "JUMP_IF_LTE_ACC BLAH",
])
def test_parse_line_raises(test_input):
    with pytest.raises(OperationParsingError):
        jump_if_lte_acc_op.parse_line(test_input)
