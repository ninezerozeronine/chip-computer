...
class OPCODE(Token):
    ...
    _OPCODE_TO_COMPONENT = {
        ...
        "JUMP_IF_CARRY_FLAG": JUMP_IF_CARRY_FLAG,
        "JUMP_IF_NOT_CARRY_FLAG": JUMP_IF_NOT_CARRY_FLAG,
        "JUMP_IF_BORROW_FLAG": JUMP_IF_BORROW_FLAG,
        "JUMP_IF_NOT_BORROW_FLAG": JUMP_IF_NOT_BORROW_FLAG,
