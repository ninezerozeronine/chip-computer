...
class OpCode(Enum):
    ...
    JUMP_IF_CARRYBORROW_FLAG = auto()
    JUMP_IF_NOT_CARRYBORROW_FLAG = auto()
...
JUMP_IF_CARRYBORROW_FLAG = OpCode.JUMP_IF_CARRYBORROW_FLAG
JUMP_IF_NOT_CARRYBORROW_FLAG = OpCode.JUMP_IF_NOT_CARRYBORROW_FLAG
