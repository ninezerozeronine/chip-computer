...
def generate_microcode_templates():
    ...
    Returns:
        list(DataTemplate): DataTemplates for all the JUMP_IF_GT_ACC
        microcode.
    """
...
def parse_line(line):
    ...
    If a line is not identifiably an JUMP_IF_GT_ACC assembly line,
