...
from sixteen_bit_computer.operations import jump_if_lt_acc_op
...
def generate_parse_line_test_data():
    ...
    test_input = "   JUMP_IF_LT_ACC B #123   "
    mc_0 = get_machine_code_byte_template()
    mc_0["byte_type"] = "instruction"
    mc_0["bitstring"] = "00110010"
    ...
    test_input = "   JUMP_IF_LT_ACC #55 #123   "
    mc_0 = get_machine_code_byte_template()
    mc_0["byte_type"] = "instruction"
    mc_0["bitstring"] = "00110111"
...
def test_parse_line(test_input, expected):
    assert jump_if_lt_acc_op.parse_line(test_input) == expected
